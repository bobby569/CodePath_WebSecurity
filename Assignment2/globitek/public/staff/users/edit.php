...
if(is_post_request()) {
  ...
  if(isset($_POST['first_name'])) { $user['first_name'] = strip_tags($_POST['first_name']); }
  if(isset($_POST['last_name'])) { $user['last_name'] = strip_tags($_POST['last_name']); }
  if(isset($_POST['username'])) { $user['username'] = strip_tags($_POST['username']); }
  if(isset($_POST['email'])) { $user['email'] = strip_tags($_POST['email']); }
